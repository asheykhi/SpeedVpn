        ...
        try {
            ...
            App.appCompatActivity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    MainActivity.connect.setText(R.string.disconnecting);
                    MainActivity.connect.setClickable(false);
                    MainActivity.connectedAnim.setVisibility(View.INVISIBLE);
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            if (!Constants.btnStatus) {
                                MainActivity.connect.setText(App.appCompatActivity.getResources().getString(R.string.tapTpConnect));
                             }
